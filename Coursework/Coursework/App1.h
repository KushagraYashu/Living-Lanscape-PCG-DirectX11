...
protected:
    ...
    void finalRender();           // Final rendering pass
...
private:
    ...
    CloudsShader* cloudsShader;              // Clouds shader for rendering clouds
    ...
    QuadMesh* quad;
    SphereMesh* sphere;                // Sphere mesh for demonstrating volumetric rendering
    SphereMesh* volumetricSphere;
